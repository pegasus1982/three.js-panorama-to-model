(function () {
  ...
  var SettingPanel = function (containerSelector, handlers) {
    ...
    this.init = () => {
      ...
      <div id="setting-panel-container" class="">
        <div class="content">
    ...
    this.configRoomGizmoPanel = () => {
      ...
      <div class="">
        ...
        <div><input id="input-vertex-count" type="number" value="4" min="3" max="10"/></div>
      </div>
      `)

      $('#input-vertex-count').change(function () {
        let count = parseInt($(this).val());
        typeof _self.eventHandlers.onRoomGizmoVertexCountChanged === 'function' && _self.eventHandlers.onRoomGizmoVertexCountChanged(count);
      })
    }
    ...
    this.configCameras = () => {
      ...
      <div class="">
        <hr>
        <h4 class="title">Camera Type</h4>
        <div>
          <select id="select-camera-type">
      ...
      $('#select-camera-type').change(function () {
        let type = $(this).val();
        typeof _self.eventHandlers.onCameraTypeChanged === 'function' && _self.eventHandlers.onCameraTypeChanged(type);
      })
    }
